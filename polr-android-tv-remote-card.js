...
class PoLRTouchpad extends s {
    connectedCallback() {
        ...
        this._mc.on("panstart panmove", (event) => {
            ...
            this.circle.style.left = `${this.clamp(clientX - rect.left - size, 0 - size, rect.width + size - rect.left)}px`;
