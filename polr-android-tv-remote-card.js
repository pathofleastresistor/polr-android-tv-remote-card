...
class PoLRHeaderCard extends s$1 {
    constructor() {
        super();
    }
    render() {
...
class PoLRRemoteButton extends s$1 {
    constructor() {
        super();
    }
    render() {
...
class PoLRATVRemoteCard extends s$1 {
        ...
        return x `
            <div class="grid remote-grid">
                ...
                <div
                    ...
                    class="center remote-button"></div>
    ...
    _render_cardheader() {
        return x `
            <div class="header-grid">
                ...
                <div class="header-additional">
                    <div @click=${this._press_power}>${PowerIcon}</div>
                </div>
            </div>
        `;
    }
    ...
    _render_hbomax() {
        return x `
            <div
                @click=${{
            handleEvent: () => this._turn_on("https://play.hbomax.com"),
        }}
                class="remote-button">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
    ...
    _render_hulu() {
        return x `
            <div
                @click=${{ handleEvent: () => this._turn_on("HULU") }}
                class="remote-button">
                <svg
                    width="48px"
                    height="48px"
    ...
    _render_youtube() {
        return x `
            <div
                @click=${{
            handleEvent: () => this._turn_on("https://www.youtube.com"),
        }}
                class="remote-button">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
