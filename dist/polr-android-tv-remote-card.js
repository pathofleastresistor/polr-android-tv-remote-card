 ...
 */
const W = globalThis, nt = W.ShadowRoot && (W.ShadyCSS === void 0 || W.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, st = Symbol(), ft = /* @__PURE__ */ new WeakMap();
let zt = class {
  constructor(t, i, o) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: qt, defineProperty: Zt, getOwnPropertyDescriptor: Gt, getOwnPropertyNames: Jt, getOwnPropertySymbols: Qt, getPrototypeOf: te } = Object, J = globalThis, _t = J.trustedTypes, ee = _t ? _t.emptyScript : "", ie = J.reactiveElementPolyfillSupport, V = (e, t) => e, X = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ee : null;
      break;
  ...
  return i;
} }, lt = (e, t) => !qt(e, t), gt = { attribute: !0, type: String, converter: X, reflect: !1, useDefault: !1, hasChanged: lt };
...
let O = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(V("properties"))) {
      const i = this.properties, o = [...Jt(i), ...Qt(i)];
  ...
  requestUpdate(t, i, o, r = !1, a) {
    if (t !== void 0) {
      ...
      if (r === !1 && (a = this[t]), o ??= n.getPropertyOptions(t), !((o.hasChanged ?? lt)(a, i) || o.useDefault && o.reflect && a === this._$Ej?.get(t) && !this.hasAttribute(n._$Eu(t, o)))) return;
      this.C(t, i, o);
    }
...
O.elementStyles = [], O.shadowRootOptions = { mode: "open" }, O[V("elementProperties")] = /* @__PURE__ */ new Map(), O[V("finalized")] = /* @__PURE__ */ new Map(), ie?.({ ReactiveElement: O }), (J.reactiveElementVersions ??= []).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ct = globalThis, bt = (e) => e, Y = ct.trustedTypes, yt = Y ? Y.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Ut = "$lit$", E = `lit$${Math.random().toFixed(9).slice(2)}$`, Ot = "?" + E, oe = `<${Ot}>`, T = document, j = () => T.createComment(""), B = (e) => e === null || typeof e != "object" && typeof e != "function", dt = Array.isArray, re = (e) => dt(e) || typeof e?.[Symbol.iterator] == "function", ot = `[ 	
\f\r]`, H = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $t = /-->/g, xt = />/g, S = RegExp(`>|${ot}(?:([^\\s"'>=/]+)(${ot}*=${ot}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), wt = /'/g, At = /"/g, Rt = /^(?:script|style|textarea|title)$/i, Dt = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), h = Dt(1), ae = Dt(2), w = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Et = /* @__PURE__ */ new WeakMap(), C = T.createTreeWalker(T, 129);
function Nt(e, t) {
...
const ne = (e, t) => {
  ...
  for (let c = 0; c < i; c++) {
    const s = e[c];
    let p, f, l = -1, v = 0;
    for (; v < s.length && (n.lastIndex = v, f = n.exec(s), f !== null); ) v = n.lastIndex, n === H ? f[1] === "!--" ? n = $t : f[1] !== void 0 ? n = xt : f[2] !== void 0 ? (Rt.test(f[2]) && (r = RegExp("</" + f[2], "g")), n = S) : f[3] !== void 0 && (n = S) : n === S ? f[0] === ">" ? (n = r ?? H, l = -1) : f[1] === void 0 ? l = -2 : (l = n.lastIndex - f[2].length, p = f[1], n = f[3] === void 0 ? S : f[3] === '"' ? At : wt) : n === At || n === wt ? n = S : n === $t || n === xt ? n = H : (n = S, r = void 0);
    const u = n === S && e[c + 1].startsWith("/>") ? " " : "";
    a += n === H ? s + oe : l >= 0 ? (o.push(p), s.slice(0, l) + Ut + s.slice(l) + E + u) : s + E + (l === -2 ? c : u);
  }
  return [Nt(e, a + (e[i] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
class F {
  constructor({ strings: t, _$litType$: i }, o) {
    ...
    this.parts = [];
    let a = 0, n = 0;
    const c = t.length - 1, s = this.parts, [p, f] = ne(t, i);
    if (this.el = F.createElement(p, o), C.currentNode = this.el.content, i === 2 || i === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (r = C.nextNode()) !== null && s.length < c; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const l of r.getAttributeNames()) if (l.endsWith(Ut)) {
          const v = f[n++], u = r.getAttribute(l).split(E), m = /([.?@])?(.*)/.exec(v);
          s.push({ type: 1, index: a, name: m[2], strings: u, ctor: m[1] === "." ? le : m[1] === "?" ? ce : m[1] === "@" ? de : Q }), r.removeAttribute(l);
        } else l.startsWith(E) && (s.push({ type: 6, index: a }), r.removeAttribute(l));
        if (Rt.test(r.tagName)) {
          const l = r.textContent.split(E), v = l.length - 1;
          if (v > 0) {
            r.textContent = Y ? Y.emptyScript : "";
            for (let u = 0; u < v; u++) r.append(l[u], j()), C.nextNode(), s.push({ type: 2, index: ++a });
            r.append(l[v], j());
          }
        }
      } else if (r.nodeType === 8) if (r.data === Ot) s.push({ type: 2, index: a });
      else {
        let l = -1;
        for (; (l = r.data.indexOf(E, l + 1)) !== -1; ) s.push({ type: 7, index: a }), l += E.length - 1;
      }
      a++;
    }
  }
...
class se {
  ...
  u(t) {
    ...
    C.currentNode = r;
    let a = C.nextNode(), n = 0, c = 0, s = o[0];
    for (; s !== void 0; ) {
      if (n === s.index) {
        let p;
        s.type === 2 ? p = new N(a, a.nextSibling, this, t) : s.type === 1 ? p = new s.ctor(a, s.name, s.strings, this, t) : s.type === 6 && (p = new pe(a, this, t)), this._$AV.push(p), s = o[++c];
      }
...
class N {
  ...
  _$AI(t, i = this) {
    t = D(this, t, i), B(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== w && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : re(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _$AC(t) {
    ...
    return i === void 0 && Et.set(t.strings, i = new F(t)), i;
  }
  k(t) {
    dt(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let o, r = 0;
    for (const a of t) r === i.length ? i.push(o = new N(this.O(j()), this.O(j()), this, this.options)) : o = i[r], o._$AI(a), r++;
...
class Q {
  ...
  _$AI(t, i = this, o, r) {
    ...
    let n = !1;
    if (a === void 0) t = D(this, t, i, 0), n = !B(t) || t !== this._$AH && t !== w, n && (this._$AH = t);
    else {
      const c = t;
      let s, p;
      for (t = a[0], s = 0; s < a.length - 1; s++) p = D(this, c[o + s], i, s), p === w && (p = this._$AH[s]), n ||= !B(p) || p !== this._$AH[s], p === d ? t = d : t !== d && (t += (p ?? "") + a[s + 1]), this._$AH[s] = p;
    }
    n && !r && this.j(t);
  }
  j(t) {
...
const he = { I: N }, ue = ct.litHtmlPolyfillSupport;
ue?.(F, N), (ct.litHtmlVersions ??= []).push("3.3.3");
const ve = (e, t, i) => {
  const o = i?.renderBefore ?? t;
  let r = o._$litPart$;
  if (r === void 0) {
    const a = i?.renderBefore ?? null;
    o._$litPart$ = r = new N(t.insertBefore(j(), a), a, void 0, i ?? {});
  }
  return r._$AI(e), r;
};
/**
...
R._$litElement$ = !0, R.finalized = !0, pt.litElementHydrateSupport?.({ LitElement: R });
const fe = pt.litElementPolyfillSupport;
fe?.({ LitElement: R });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const me = { attribute: !0, type: String, converter: X, reflect: !1, hasChanged: lt }, _e = (e = me, t, i) => {
...
function M(e) {
  return (t, i) => typeof i == "object" ? _e(e, t, i) : ((o, r, a) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ge = (e, t, i) => (i.configurable = !0, i.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, i), i);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ht = { CHILD: 2, ELEMENT: 6 }, Vt = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Lt = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: be } = he, kt = (e) => e, ye = (e) => e.strings === void 0, St = () => document.createComment(""), I = (e, t, i) => {
  const o = e._$AA.parentNode, r = t === void 0 ? e._$AB : t._$AA;
  if (i === void 0) {
    const a = o.insertBefore(St(), r), n = o.insertBefore(St(), r);
    i = new be(a, n, e, e.options);
  } else {
    ...
    if (a !== r || c) {
      let s = i._$AA;
      for (; s !== a; ) {
        const p = kt(s).nextSibling;
        kt(o).insertBefore(s, r), s = p;
      }
    }
  }
  return i;
}, P = (e, t, i = e) => (e._$AI(t, i), e), $e = {}, xe = (e, t = $e) => e._$AH = t, we = (e) => e._$AH, rt = (e) => {
...
const Pt = (e, t, i) => {
  ...
  update(e, [t, i, o]) {
    const r = we(e), { values: a, keys: n } = this.dt(t, i, o);
    if (!Array.isArray(r)) return this.ut = n, a;
    const c = this.ut ??= [], s = [];
    let p, f, l = 0, v = r.length - 1, u = 0, m = a.length - 1;
    for (; l <= v && u <= m; ) if (r[l] === null) l++;
    else if (r[v] === null) v--;
    else if (c[l] === n[u]) s[u] = P(r[l], a[u]), l++, u++;
    else if (c[v] === n[m]) s[m] = P(r[v], a[m]), v--, m--;
    else if (c[l] === n[m]) s[m] = P(r[l], a[m]), I(e, s[m + 1], r[l]), l++, m--;
    else if (c[v] === n[u]) s[u] = P(r[v], a[u]), I(e, r[l], r[v]), v--, u++;
    else if (p === void 0 && (p = Pt(n, u, m), f = Pt(c, l, v)), p.has(c[l])) if (p.has(c[v])) {
      const y = f.get(n[u]), it = y !== void 0 ? r[y] : null;
      if (it === null) {
        const vt = I(e, r[l]);
        P(vt, a[u]), s[u] = vt;
      } else s[u] = P(it, a[u]), I(e, r[l], it), r[y] = null;
      u++;
    } else rt(r[v]), v--;
    else rt(r[l]), l++;
    for (; u <= m; ) {
  ...
  for (const o of Object.values(e.entities ?? {}))
    if (o.device_id === i && o.entity_id.startsWith("media_player."))
      return o.entity_id;
  return null;
}, at = (e) => e === void 0 || e.state === "unavailable" || e.state === "unknown", Pe = (e, t) => {
  const i = e.states?.[t.entity], o = Se(e, t), r = o ? e.states?.[o] : void 0, a = r?.attributes ?? {}, n = i?.attributes ?? {}, c = r && !at(r) ? r.state !== "off" : i?.state === "on";
  return {
    remoteId: t.entity,
    playerId: o,
    remote: i,
...
}, ut = (e, t, i) => e.callService("remote", "send_command", {
  entity_id: t.remoteId,
  command: i
}), Ce = (e, t, i) => ut(e, t, `${ke}${i}`), Te = (e, t, i, o) => {
  ...
  const n = Ee[o];
  return n ? ut(e, i, n) : Promise.resolve();
}, ze = (e, t, i) => {
  switch (i.action) {
    case "activity":
...
}, x = (e) => typeof e == "object" && e !== null && !Array.isArray(e), Bt = (e) => x(e) && typeof e.service == "string";
let Ct = /* @__PURE__ */ new Set();
const q = (e) => {
  Ct.has(e) || (Ct.add(e), console.warn(`polr-android-tv-remote-card: ${e}`));
}, De = (e) => {
  if (typeof e == "string") {
    const r = Ue[e];
    return r ? {
  ...
  return Bt(e) ? {
    ...
    action: {
      action: "service",
      service: e.service,
      ...x(e.data) ? { data: e.data } : {},
      ...x(e.target) ? { target: e.target } : {}
    }
  } : typeof e.url == "string" ? {
    ...i ? { name: i } : {},
    ...t ? { icon: t } : {},
  ...
  const i = typeof e.remote == "string" ? Re[e.remote] : void 0;
  typeof e.remote == "string" && !i && q(`unknown remote style "${e.remote}" — falling back to ${_.pad}`);
  const o = Me.includes(e.pad) ? e.pad : i?.pad ?? _.pad, r = typeof e.volume == "boolean" ? e.volume : void 0, a = {
    ...x(e.overrides) ? e.overrides : {}
  };
  for (const [p, f] of Object.entries(Oe)) {
    if (a[f]) continue;
    const l = e[p];
    Bt(l) ? a[f] = {
      service: l.service,
      ...x(l.data) ? { data: l.data } : {},
      ...x(l.target) ? { target: l.target } : {}
    } : l !== void 0 && q(`override "${p}" is not a {service, data} object and was ignored`);
  }
  const c = (Array.isArray(e.apps) ? e.apps : []).map(De).filter((p) => p !== null), s = (p, f) => p === void 0 ? f : p;
  return {
    ...e,
    type: e.type,
    entity: t,
...
const L = (e, t) => {
  ...
  for (const o of i) o._$AO?.(t, !1), L(o, t);
  return !0;
}, Z = (e) => {
  let t, i;
  do {
...
function Le(e) {
  this._$AN !== void 0 ? (Z(this), this._$AM = e, Ft(this)) : this._$AM = e;
}
function je(e, t = !1, i = 0) {
  const o = this._$AH, r = this._$AN;
  if (r !== void 0 && r.size !== 0) if (t) if (Array.isArray(o)) for (let a = i; a < o.length; a++) L(o[a], !1), Z(o[a]);
  else o != null && (L(o, !1), Z(o));
  else L(this, e);
}
const Be = (e) => {
  e.type == ht.CHILD && (e._$AP ??= je, e._$AQ ??= Le);
};
class Fe extends Lt {
  constructor() {
  ...
  _$AT(t, i, o) {
    super._$AT(t, i, o), Ft(this), this.isConnected = t._$AU;
  }
  _$AO(t, i = !0) {
    t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), i && (L(this, t), Z(this));
  }
  setValue(t) {
    if (ye(this._$Ct)) this._$Ct._$AI(t, this);
    else {
...
}, Ke = (e, t) => G(e, "hass-more-info", { entityId: t }), We = (e, t, i = "var(--state-inactive-color, #9e9e9e)") => t === "unavailable" || t === "unknown" ? "var(--state-unavailable-color, var(--disabled-color))" : `var(--state-${e}-${t}-color, var(--state-icon-color, ${i}))`, Xe = 500, Ye = 220, qe = 40;
class Ze extends Fe {
  constructor(t) {
  ...
  _fire() {
    ...
    t && (this._inFlight || (this._inFlight = !0, Promise.resolve().then(() => {
      this._inFlight = !1;
    }), t.haptics !== !1 && this._element && G(this._element, "haptic", "light"), t.onPress()));
  }
  _stop() {
...
`;
var Ge = Object.defineProperty, Je = Object.getOwnPropertyDescriptor, A = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Je(t, i) : t, a = e.length - 1, n; a >= 0; a--)
...
let g = class extends R {
  constructor() {
    super(...arguments), this.pad = "buttons", this.repeat = !0, this.haptics = !0, this.inlineExtras = !1, this.showFavorite = !1, this._tracking = !1, this._startX = 0, this._startY = 0, this._onPointerDown = (e) => {
      ...
      if (Math.abs(o) < Tt && Math.abs(r) < Tt) {
        this._emit("center");
        return;
      }
  ...
  _emit(e) {
    G(this, "atv-nav", { direction: e });
  }
  _emitButton(e) {
    G(this, "atv-button", { button: e });
  }
  _key(e, t, i, o = "") {
    return h`
      <button
  ...
  _extra(e, t, i) {
    return h`
      <button
        ...
        type="button"
        aria-label=${i}
        ${k({ onPress: () => this._emitButton(e), haptics: this.haptics })}
      >
        <ha-icon icon=${t}></ha-icon>
      </button>
    `;
    ...
    return h`
      <div class="dpad" role="group" aria-label="Directional pad">
        ...
        <button
          ...
          type="button"
          aria-label="Select"
          ${k({ onPress: () => this._emit("center"), haptics: this.haptics })}
        >
          <span>OK</span>
        </button>
...
A([
  M({ type: Boolean, attribute: "inline-extras" })
...
var ti = Object.defineProperty, ei = Object.getOwnPropertyDescriptor, K = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? ei(t, i) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && ti(t, i, r), r;
};
const ii = "2.0.0", et = "polr-android-tv-remote-card";
let z = class extends R {
  ...
  get _device() {
    if (!(!this.hass || !this._config))
      return Pe(this.hass, this._config);
  }
  _press(e) {
    const t = this._device;
    !this.hass || !this._config || !t || Te(this.hass, this._config, t, e);
  }
  _navigate(e) {
  ...
  _launch(e) {
    const t = this._device;
    !this.hass || !t || ze(this.hass, t, e.action).catch((i) => {
      console.error(i);
    });
  }
  async _sendText() {
    ...
    if (!(!this.hass || !e || !t)) {
      this._sending = !0;
      try {
        await Ce(this.hass, e, t), this._text = "";
      } finally {
        this._sending = !1;
      }
    }
  ...
  _renderHeader(e) {
    ...
    return h`
      <div class="tile">
        ${e.picture ? h`<img class="now-playing-art" src=${e.picture} alt="" />` : h`
              <button
                class="tile-icon interactive"
                type="button"
                aria-label="More information"
                @click=${() => Ke(this, e.playerId ?? e.remoteId)}
              >
        ...
        ${t.show_power ? h`
              <button
                ...
                ${k({ onPress: () => this._press("power"), haptics: t.haptics })}
              >
  ...
  _renderChips(e) {
    ...
    const t = [];
    return e.muted ? t.push(h`<span class="chip warn"><ha-icon icon="mdi:volume-off"></ha-icon>Muted</span>`) : e.volume !== void 0 && t.push(h`<span class="chip accent">${Math.round(e.volume * 100)}%</span>`), t.length ? h`<div class="tile" style="padding-top:0;min-height:0">
  ...
  _renderAppIcon(e) {
    ...
    if (t.startsWith("brand:")) {
      const i = Ve[t.slice(6)];
      if (i) return h`${i}`;
    }
    return t.startsWith("/") || t.startsWith("http") ? h`<img src=${t} alt="" />` : h`<ha-icon icon=${t}></ha-icon>`;
  }
  _renderApps() {
    const e = this._config;
    if (!e.apps.length) return d;
    const t = e.app_columns === "auto" ? Ie(e.apps.length) : e.app_columns;
    return h`
      ${e.show_section_labels ? h`<div class="section-head">
      ...
      (i) => h`
            <button
              ...
              ${k({ onPress: () => this._launch(i), haptics: e.haptics })}
            >
  ...
  render() {
    ...
    if (!t.found)
      ...
      `;
    const i = We("media_player", t.on ? "on" : "off"), o = t.available;
    return h`
      <ha-card style="--tile-color:${i}">
        ${e.show_header ? this._renderHeader(t) : d}
        ${e.show_header && t.playerId === null ? h`<div class="notice warn">
...
console.info(`%c ${et} %c ${ii} `, "background:#555;color:#fff", "background:#3f51b5;color:#fff");
export {
  ii as CARD_VERSION,
