 ...
 */
const Q = globalThis, vt = Q.ShadowRoot && (Q.ShadyCSS === void 0 || Q.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ft = Symbol(), Pt = /* @__PURE__ */ new WeakMap();
let oe = class {
  constructor(e, i, o) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ke, defineProperty: Se, getOwnPropertyDescriptor: Te, getOwnPropertyNames: Ee, getOwnPropertySymbols: Pe, getPrototypeOf: Ce } = Object, nt = globalThis, Ot = nt.trustedTypes, Oe = Ot ? Ot.emptyScript : "", Me = nt.reactiveElementPolyfillSupport, F = (t, e) => t, tt = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Oe : null;
      break;
  ...
  return i;
} }, gt = (t, e) => !ke(t, e), Mt = { attribute: !0, type: String, converter: tt, reflect: !1, useDefault: !1, hasChanged: gt };
...
let N = class extends HTMLElement {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const n of o) i.unshift(Ct(n));
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const bt = globalThis, zt = (t) => t, et = bt.trustedTypes, Lt = et ? et.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, ne = "$lit$", T = `lit$${Math.random().toFixed(9).slice(2)}$`, ae = "?" + T, ze = `<${ae}>`, L = document, q = () => L.createComment(""), X = (t) => t === null || typeof t != "object" && typeof t != "function", yt = Array.isArray, Le = (t) => yt(t) || typeof t?.[Symbol.iterator] == "function", ct = `[ 	
\f\r]`, K = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Rt = /-->/g, Dt = />/g, E = RegExp(`>|${ct}(?:([^\\s"'>=/]+)(${ct}*=${ct}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ut = /'/g, Nt = /"/g, se = /^(?:script|style|textarea|title)$/i, re = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), c = re(1), Re = re(2), A = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Ht = /* @__PURE__ */ new WeakMap(), M = L.createTreeWalker(L, 129);
function ce(t, e) {
...
const De = (t, e) => {
  ...
  for (let r = 0; r < i; r++) {
    const l = t[r];
    let m, f, h = -1, u = 0;
    for (; u < l.length && (a.lastIndex = u, f = a.exec(l), f !== null); ) u = a.lastIndex, a === K ? f[1] === "!--" ? a = Rt : f[1] !== void 0 ? a = Dt : f[2] !== void 0 ? (se.test(f[2]) && (n = RegExp("</" + f[2], "g")), a = E) : f[3] !== void 0 && (a = E) : a === E ? f[0] === ">" ? (a = n ?? K, h = -1) : f[1] === void 0 ? h = -2 : (h = a.lastIndex - f[2].length, m = f[1], a = f[3] === void 0 ? E : f[3] === '"' ? Nt : Ut) : a === Nt || a === Ut ? a = E : a === Rt || a === Dt ? a = K : (a = E, n = void 0);
    const v = a === E && t[r + 1].startsWith("/>") ? " " : "";
    s += a === K ? l + ze : h >= 0 ? (o.push(m), l.slice(0, h) + ne + l.slice(h) + T + v) : l + T + (h === -2 ? r : v);
  }
...
class Z {
  constructor({ strings: e, _$litType$: i }, o) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const r = e.length - 1, l = this.parts, [m, f] = De(e, i);
    ...
    for (; (n = M.nextNode()) !== null && l.length < r; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const h of n.getAttributeNames()) if (h.endsWith(ne)) {
          ...
          l.push({ type: 1, index: s, name: p[2], strings: v, ctor: p[1] === "." ? Ne : p[1] === "?" ? He : p[1] === "@" ? Ie : at }), n.removeAttribute(h);
      ...
      } else if (n.nodeType === 8) if (n.data === ae) l.push({ type: 2, index: s });
      else {
        let h = -1;
...
class Ue {
  ...
  u(e) {
    ...
    M.currentNode = n;
    let s = M.nextNode(), a = 0, r = 0, l = o[0];
    for (; l !== void 0; ) {
      if (a === l.index) {
        let m;
        l.type === 2 ? m = new B(s, s.nextSibling, this, e) : l.type === 1 ? m = new l.ctor(s, l.name, l.strings, this, e) : l.type === 6 && (m = new Ve(s, this, e)), this._$AV.push(m), l = o[++r];
      }
...
class B {
  ...
  _$AC(e) {
    ...
    return i === void 0 && Ht.set(e.strings, i = new Z(e)), i;
  }
  k(e) {
...
class at {
  ...
  _$AI(e, i = this, o, n) {
    ...
    if (s === void 0) e = V(this, e, i, 0), a = !X(e) || e !== this._$AH && e !== A, a && (this._$AH = e);
      ...
      const r = e;
      let l, m;
      for (e = s[0], l = 0; l < s.length - 1; l++) m = V(this, r[o + l], i, l), m === A && (m = this._$AH[l]), a ||= !X(m) || m !== this._$AH[l], m === d ? e = d : e !== d && (e += (m ?? "") + s[l + 1]), this._$AH[l] = m;
    }
    a && !n && this.j(e);
  }
  j(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Xe } = Be, It = (t) => t, Ze = (t) => t.strings === void 0, Vt = () => document.createComment(""), W = (t, e, i) => {
  const o = t._$AA.parentNode, n = e === void 0 ? t._$AB : e._$AA;
  if (i === void 0) {
    const s = o.insertBefore(Vt(), n), a = o.insertBefore(Vt(), n);
    ...
    if (s !== n || r) {
      let l = i._$AA;
      for (; l !== s; ) {
        const m = It(l).nextSibling;
        It(o).insertBefore(l, n), l = m;
      }
    }
  }
  return i;
}, P = (t, e, i = t) => (t._$AI(e, i), t), Ge = {}, Je = (t, e = Ge) => t._$AH = e, Qe = (t) => t._$AH, lt = (t) => {
...
const Bt = (t, e, i) => {
  ...
  update(t, [e, i, o]) {
    ...
    else if (r[h] === a[v]) l[v] = P(n[h], s[v]), h++, v++;
    else if (r[u] === a[p]) l[p] = P(n[u], s[p]), u--, p--;
    else if (r[h] === a[p]) l[p] = P(n[h], s[p]), W(t, l[p + 1], n[h]), h++, p--;
    else if (r[u] === a[v]) l[v] = P(n[u], s[v]), W(t, n[h], n[u]), u--, v++;
    else if (m === void 0 && (m = Bt(a, v, p), f = Bt(r, h, u)), m.has(r[h])) if (m.has(r[u])) {
      const _ = f.get(a[v]), $ = _ !== void 0 ? n[_] : null;
      if ($ === null) {
        const Et = W(t, n[h]);
        P(Et, s[v]), l[v] = Et;
      } else l[v] = P($, s[v]), W(t, n[h], $), n[_] = null;
      v++;
    } else lt(n[u]), u--;
    else lt(n[h]), h++;
    for (; v <= p; ) {
...
}, ei = (t, e) => st(t, "hass-more-info", { entityId: e }), ii = (t, e, i = "var(--state-inactive-color, #9e9e9e)") => e === "unavailable" || e === "unknown" ? "var(--state-unavailable-color, var(--disabled-color))" : `var(--state-${t}-${e}-color, var(--state-icon-color, ${i}))`, oi = (t) => typeof t == "object" && t !== null && !Array.isArray(t), H = (t) => oi(t) && typeof t.action == "string", it = (t) => t !== void 0 && t.action !== "none", At = (t) => {
  const e = (t ?? "").split(".");
  ...
  switch (i.action) {
    ...
    case "call-service": {
      ...
      const [a, r] = s, l = i.action === "perform-action" ? i.data : i.data ?? i.service_data;
      return e.callService(a, r, l ?? {}, i.target);
    }
  }
}, x = {
  PAUSE: 1,
  ...
  for (const o of Object.values(t.entities ?? {}))
    if (o.device_id === i && o.entity_id.startsWith("media_player."))
      return o.entity_id;
  return null;
}, dt = (t) => t === void 0 || t.state === "unavailable" || t.state === "unknown", si = (t, e) => {
  const i = t.states?.[e.entity], o = pe(t, e), n = o ? t.states?.[o] : void 0, s = n?.attributes ?? {}, a = i?.attributes ?? {}, r = e.volume_entity ?? o, m = (e.volume_entity && e.volume_entity !== o ? t.states?.[e.volume_entity] : n)?.attributes ?? {}, f = n && !dt(n) ? n.state !== "off" : i?.state === "on";
  return {
    remoteId: e.entity,
    playerId: o,
    remote: i,
...
}, I = (t, e) => (t.features & e) !== 0, jt = (t, e) => (t.volumeFeatures & e) !== 0, Kt = (t) => t.volume !== void 0, li = ["volume_up", "volume_down", "volume_mute"], di = (t, e) => t.volume_entity !== void 0 && t.volume_entity !== e.playerId || li.some((i) => it(t.overrides[i]?.tap_action)), hi = (t, e) => {
  ...
  command: i
}), pi = (t, e, i) => St(t, e, `${ai}${i}`), ui = (t, e, i, o, n) => {
  ...
  switch (o) {
    ...
    case "volume_up":
    case "volume_down":
      if (i.volumeId && jt(i, x.VOLUME_STEP))
      ...
      break;
    case "volume_mute":
      if (i.volumeId && i.muted !== void 0 && jt(i, x.VOLUME_MUTE))
...
const y = (t) => {
  ...
  const e = (Array.isArray(t.buttons) ? t.buttons : []).map(be).filter((i) => i !== null);
  return {
    ...typeof t.name == "string" ? { name: t.name } : {},
    ...typeof t.columns == "number" && t.columns > 0 ? { columns: t.columns } : {},
    buttons: e
  };
}, Yt = (t) => typeof t == "string" && ue.includes(t), yi = (t) => {
  if (Yt(t)) return { type: t };
  if (!b(t))
  ...
  const o = Array.isArray(t.layout) ? t.layout.map(yi).filter((r) => r !== null) : [
  ...
  const o = fi.includes(t.pad) ? t.pad : i ?? g.pad, n = typeof t.volume == "boolean" ? t.volume : void 0, s = {};
  if (b(t.overrides))
  ...
  ) : g.transport_buttons, m = (Array.isArray(t.sections) ? t.sections : []).map(ge).filter((p) => p !== null), h = (Array.isArray(t.apps) ? t.apps : []).map(be).filter((p) => p !== null), u = (p, _) => p === void 0 ? _ : p, v = {
    ...t,
    type: t.type,
    entity: e,
...
const Si = (t) => {
  t.type == xt.CHILD && (t._$AP ??= ki, t._$AQ ??= Ai);
};
class Ti extends he {
  constructor() {
...
const qt = 500, Xt = 220, Zt = 40, Gt = 500, Ei = 250, Jt = 12;
class Pi extends Ti {
  constructor(e) {
...
`;
var Ci = Object.defineProperty, Oi = Object.getOwnPropertyDescriptor, D = (t, e, i, o) => {
  for (var n = o > 1 ? void 0 : o ? Oi(e, i) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (n = (o ? a(e, i, n) : a(n)) || n);
  return o && n && Ci(e, i, n), n;
};
const Qt = 0.06, Mi = {
  ArrowUp: "up",
  ArrowDown: "down",
...
let k = class extends z {
  constructor() {
    super(...arguments), this.pad = "buttons", this.repeat = !0, this.haptics = !0, this._tracking = !1, this._startX = 0, this._startY = 0, this._onPointerDown = (t) => {
      ...
      if (Math.abs(o) < Qt && Math.abs(n) < Qt) {
        this._emit("center");
        return;
      }
...
var zi = Object.defineProperty, Li = Object.getOwnPropertyDescriptor, G = (t, e, i, o) => {
...
let w = class extends z {
  constructor() {
    super(...arguments), this._editing = null, this._openSection = null, this._computeLabel = (t) => Ii[t.name] ?? t.name, this._computeHelper = (t) => Vi[t.name];
  }
  setConfig(t) {
    this._config = ye(t);
  }
  ...
  _emit(t) {
    st(this, "config-changed", { config: xi(t) });
  }
  _formChanged(t) {
    t.stopPropagation();
    ...
    for (const o of w.ACTION_BUTTONS) {
      ...
      H(s) && s.action !== "none" ? i[o] = { ...a, tap_action: s } : (delete a.tap_action, Object.keys(a).length ? i[o] = a : delete i[o]);
    }
    this._emit({
      ...this._config,
      ...e,
  ...
  _setActionValue(t, e, i) {
    const o = this._tiles(t)[e].action;
    this._updateTile(t, e, { action: ie(mt(o), i) });
  }
  /* ------------------------------------------------------------ layout -- */
  /**
    ...
    return c`
      <li class="row">
        ...
        <div class="tile-info">
          ...
          <div class="secondary"><span>${vi(e.action, e.entity)}</span></div>
        </div>
        <button
          class="icon-button"
          title="Move up"
  ...
  _renderAppForm(t, e, i) {
    const o = mt(e.action), n = te.find((a) => a.value === o), s = Bi(e.action);
    return c`
      <li class="form-host">
        <div class="form">
          <div class="fields">
      ...
      H(r) && this._updateTile(t, i, { action: r });
    }}
                  ></ha-form>
   ...
   */
  _renderCurrentApp() {
    const t = this._config, e = pe(this.hass, t), i = e ? this.hass.states?.[e] : void 0, o = i?.attributes?.app_id, n = i?.attributes?.app_name;
    if (!o) return d;
    const s = t.apps.some(
    ...
    return c`
      ...
      ${s ? c`<div class="hint">${n ?? o} is already in the list.</div>` : c`
            <div class="chips">
              <button
                class="chip accent"
  ...
  _renderLayoutRow(t, e, i, o) {
    const n = t.type === "section" ? t : void 0, s = t.type === "section" ? void 0 : Ri[t.type], a = n?.buttons.length ?? 0, r = t.hidden ? "Hidden" : n ? `${a} ${a === 1 ? "button" : "buttons"}` : "";
    return c`
  ...
  render() {
    ...
    return c`
      ...
      (i) => c`
        ...
        name: C[i].label,
        icon: `brand:${i}`,
        action: { action: "activity", activity: C[i].activity }
      })}
                    >
                      <ha-icon icon="mdi:plus"></ha-icon>${C[i].label}
                    </button>
                  `
    )}
              </div>
...
}, Bi = (t) => t.action === "service" ? ht(t.service, t.data, t.target) : mt(t) === "action" ? t : void 0, ie = (t, e) => {
  switch (t) {
    case "activity":
...
var Ki = Object.defineProperty, Wi = Object.getOwnPropertyDescriptor, J = (t, e, i, o) => {
  for (var n = o > 1 ? void 0 : o ? Wi(e, i) : e, s = t.length - 1, a; s >= 0; s--)
    (a = t[s]) && (n = (o ? a(e, i, n) : a(n)) || n);
  return o && n && Ki(e, i, n), n;
};
const Fi = "2.1.1-beta.9", rt = "polr-android-tv-remote-card";
let S = class extends z {
  ...
  get _device() {
    if (!(!this.hass || !this._config))
      return si(this.hass, this._config);
  }
  /**
  ...
  _press(t) {
    ...
    !this.hass || !this._config || !e || this._run(ui(this.hass, this._config, e, t, this));
  }
  /**
  ...
  _launch(t) {
    const e = this._device;
    !this.hass || !e || this._run(mi(this.hass, e, t, this));
  }
  async _sendText() {
    ...
    if (!(!this.hass || !t || !e)) {
      this._sending = !0;
      try {
        await pi(this.hass, t, e), this._text = "";
      } finally {
        this._sending = !1;
      }
    }
  ...
  /* ------------------------------------------------------------- header -- */
  _renderHeader(t) {
    const e = this._config, i = t.available ? t.on ? t.appName ?? "On" : "Off" : "Unavailable", o = t.on && t.available ? me(t.appName) : void 0;
    return c`
      <div class="tile">
  ...
  _renderChips(t) {
    ...
    const e = [];
    return t.muted === !0 ? e.push(c`<span class="chip warn"><ha-icon icon="mdi:volume-off"></ha-icon>Muted</span>`) : Kt(t) && e.push(c`<span class="chip accent">${Math.round(t.volume * 100)}%</span>`), e.length ? c`<div class="tile" style="padding-top:0;min-height:0">
   ...
   */
  _renderVolume(t) {
    const e = t.on || t.volumeId !== t.playerId, i = e && t.muted === !0, o = e && t.muted !== void 0, n = e && Kt(t) ? Math.round(t.volume * 100) : void 0;
    return c`
      <div class="features">
  ...
  _renderSection(t, e, i) {
    ...
    return c`
      ...
      (n, s) => `${i}:${s}:${n.icon ?? ""}`,
      (n) => {
        const s = this.hass ? ci(this.hass, n.entity) : !1;
        return c`
              <button
   ...
   */
  _renderLayout(t) {
    const e = this._config, i = t.on, o = (n) => n.hidden ? !1 : i || n.type === "section" || n.type === "apps" ? !0 : n.type === "volume" && di(e, t);
    return c`
      ${e.layout.map((n, s) => {
      if (!o(n)) return d;
...
console.info(`%c ${rt} %c ${Fi} `, "background:#555;color:#fff", "background:#3f51b5;color:#fff");
export {
  Fi as CARD_VERSION,
